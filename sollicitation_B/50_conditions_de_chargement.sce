...
tch(n,:)=["C1","C5","T1"];//Type de chargement
ich(n,:) = [2.25*kN,-14.10*kN,40];// Intensité du chargement (dépend du type)
...
n =7;
tch(n,:)=["C1","C1","T1"];
ich(n,:) = [3.75*kN,3.758*kN,40];
ech(n,:) = [0,0,0];

n =8;
tch(n,:)=["C1","C1","T1"];
ich(n,:) = [3.75*kN,1.743*kN,40];
ech(n,:) = [0,0,0];

n =9;
tch(n,:)=["C1","C1","T1"];
ich(n,:) = [3.75*kN,2.464*kN,40];
ech(n,:) = [0,0,0];
