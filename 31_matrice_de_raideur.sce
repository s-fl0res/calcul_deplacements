...
for n = 1:E
    ...
    K_ana(1+3*(n-1):3*(n),1+3*(n-1):3*(n)) = K_ana(1+3*(n-1):3*(n),1+3*(n-1):3*(n)) + Knii;
    K_ana(1+3*(n):3*(n+1),1+3*(n-1):3*(n)) =  K_ana(1+3*(n):3*(n+1),1+3*(n-1):3*(n)) + Knji;
    K_ana(1+3*(n-1):3*(n),1+3*(n):3*(n+1)) = K_ana(1+3*(n-1):3*(n),1+3*(n):3*(n+1)) + Knij;
    K_ana(1+3*(n):3*(n+1),1+3*(n):3*(n+1)) = K_ana(1+3*(n):3*(n+1),1+3*(n):3*(n+1)) + Knjj;
